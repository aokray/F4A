...
INSERT INTO paramsv VALUES ('Logistic Regression', 'C', '{0, inf}', '1', 'C is a "regularizer", meaning it determines how smooth the decision function is. Usually it is set between 0.01 and 10.');

INSERT INTO algv
(algv_algname, algv_params, algv_type, algv_import_str)
VALUES ('K Neighbors Classifier', true, 'Learning Method', 'from sklearn.neighbors import KNeighborsClassifier');

INSERT INTO paramsv VALUES ('K Neighbors Classifier', 'n_neighbors', '{0,inf}', 3, 'n_neigbors dictates how many neigboring points are used to predict the new label of a new instance. It is usually set between 1 and ~50, depending on the size of the dataset.');
...
'<p>This has all led to the creation of the field of Fair ML, a whole field of researchers trying to discover new ways to make computational systems more fair for all people. This website is a way to demonstrate the difficulties of the problem, while also providing '
