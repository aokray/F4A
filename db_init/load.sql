...
'that preferred men over women applicants, or in the algorithm that <a href="https://www.scientificamerican.com/article/racial-bias-found-in-a-major-health-care-risk-algorithm/" target="_blank">gave white patients more time with doctors '
...
'starting place is <a href="https://arxiv.org/abs/1810.08810" target="_blank">The Frontiers of Fairness in Machine Learning</a>. F4A exists to try and educate people about this problem, while also '
'demonstrating some useful concepts around how researchers think about "fairness". If you see a term that''s confusing, hover over it and a tooltip should appear to help out or explain in more depth. Have fun trying new combinations!'
'<h4>Website Guide</h4>'
